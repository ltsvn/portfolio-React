      ...
      <section name="Home" className='relative w-full md:h-screen h-unset'>
        ...
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full px-4 py-16 md:py-0 md:flex-row md:gap-8'>
          ...
          <div className='flex flex-col justify-center items-center h-[85%] md:h-full order-2 md:order-1 md:items-start'>
            ...
            <p className='text-gray-300 py-4 max-x-md text-justify'>Determined and productive developer with a passion for
                creative solutions. Knowledgeable in user interface, testing, and debugging processes. Competent in
                JavaScript, React, and Redux. Looking for a front-end developer position at a great company to be a
                hardworking asset to any team, to learn, grow, and develop long term.
            </p>
